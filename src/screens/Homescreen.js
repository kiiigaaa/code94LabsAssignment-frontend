...
export default function Homescreen() {
    ...
    const filtereditems = items.filter(item => {
        if (selectedOption === 'nonvegetarian') {
            return item.name.toLowerCase().includes(searchQuery.toLowerCase()) && !item.isVegetarian && item.isNonVeg;
        } else if (selectedOption === 'vegetarian') {
            return item.name.toLowerCase().includes(searchQuery.toLowerCase()) && item.isVegetarian;
        } else if (selectedOption === 'item') {
            return item.name.toLowerCase().includes(searchQuery.toLowerCase()) && !item.isBeverage;
                        ...
                        <div class="row justify-content-center">
                            <div class="col-md-6">
                                ...
                                <div>
                                    ...
                                    <div class="p-3" >
                                        <label className="p-2">
                                            <input type="radio" value="item" checked={selectedOption === 'item'} onChange={handleOptionChange} />
